...
public final class HospitalTestData {
    ...
    public static void fillRegisterWithTestData(final Hospital hospital) {
        ...
        emergency.getEmployees().put(employee.getFullName(), employee);
        ...
        emergency.getEmployees().put(surgeon.getFullName(), surgeon);

        Nurse nurse = new Nurse("Nina", "Teknologi", "5");
        emergency.getEmployees().put(nurse.getFullName(), nurse);

        nurse = new Nurse("Ove", "Ralt", "6");
        emergency.getEmployees().put(nurse.getFullName(), nurse);

        Patient patient = new Patient("Inga", "Lykke", "7");
        emergency.getPatients().put(patient.getFullName(), patient);
        ...
        childrenPolyclinic.getEmployees().put(employee.getFullName(), employee);
        ...
        childrenPolyclinic.getEmployees().put(generalPractitioner.getFullName(), generalPractitioner);

        surgeon = new Surgeon("Nanna", "Na", "13");
        childrenPolyclinic.getEmployees().put(surgeon.getFullName(), surgeon);

        nurse = new Nurse("Nora", "Toriet", "14");
        childrenPolyclinic.getEmployees().put(nurse.getFullName(), nurse);

        patient = new Patient("Hans", "Omvar", "15");
        childrenPolyclinic.getPatients().put(patient.getFullName(), patient);
